...
%><%!// was -1 -> 22
private static final float MIN_T = -3;
private static final float MAX_T = +3;
...
float t = Float.parseFloat(request.getParameter("we"));
...
context.put ("rgb",rgb);
context.put ("we", request.getParameter("we"));
...
String svg = TemplateRegistry.getInstance().mergeToString("/tidegauge/overlay-tg-svg.vm",context);
