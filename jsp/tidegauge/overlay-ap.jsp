...
%><%!// was -1 -> 22
private static final float MIN_T = 960;
private static final float MAX_T = 1040;
...
float t = Float.parseFloat(request.getParameter("ap"));
...
context.put ("rgb",rgb);
context.put ("ap", request.getParameter("ap"));
...
String svg = TemplateRegistry.getInstance().mergeToString("/tidegauge/overlay-ap-svg.vm",context);
