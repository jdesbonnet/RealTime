...
%><%!// was -1 -> 22
private static final float MIN_T = 100;
private static final float MAX_T = 30;
...
float t = Float.parseFloat(request.getParameter("rh"));
...
context.put ("rgb",rgb);
context.put ("rh", request.getParameter("rh"));
...
String svg = TemplateRegistry.getInstance().mergeToString("/tidegauge/overlay-rh-svg.vm",context);
